...
class Activitylevel1no3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level1_no3)
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level1_no3)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            ...
            // Buka activity_level2
            val intent = Intent(this, Activitysoal1level2::class.java)
            startActivity(intent)

            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
            finish() // Optional: Menutup Activity saat pindah ke activity_level2
        }
