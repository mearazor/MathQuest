...
class Activitylevel2 : AppCompatActivity() {
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level2_no1)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            // Tutup popup benar
            benarPopup.dismiss()
            // Buka activity_soal2_no2
            val intent = Intent(this, Activitysoal2level2::class.java)
            startActivity(intent)
            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
            finish() // Optional: Menutup Activity saat pindah ke activity_level2_no2
        }
        btnNo.setOnClickListener {
