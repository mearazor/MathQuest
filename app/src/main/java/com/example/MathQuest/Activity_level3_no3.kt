...
class Activitylevel3no3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level3_no3)
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level3_no3)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            ...
            val intent = Intent(this, Activitysoal4level3::class.java)
            startActivity(intent)
            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
