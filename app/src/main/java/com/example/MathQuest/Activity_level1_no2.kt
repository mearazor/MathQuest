...
class Activitylevel1no2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level1_no2)
        supportActionBar?.hide()
        homeButton = findViewById(R.id.bthome)
        timerTextView = findViewById(R.id.timer)
        pertanyaanButton = findViewById(R.id.btpertanyaan)

        val jawaban1: ImageView = findViewById(R.id.jawaban1)
        val jawaban2: ImageView = findViewById(R.id.jawaban2)
        val jawaban3: ImageView = findViewById(R.id.jawaban3)
        val gamelevel1: ImageView = findViewById(R.id.gamelevel1)

        // menambahkan OnClickListener ke gamabar "gamelevel1"
        gamelevel1.setOnClickListener {
            // memutar efek suara
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level1_no2)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            benarPopup.dismiss()
            // Buka activity_soal
            val intent = Intent(this, Activitysoal3level1::class.java)
            startActivity(intent)
            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
            finish() // Optional: Menutup Activity saat pindah ke activity_soal
        }
        btnNo.setOnClickListener {
