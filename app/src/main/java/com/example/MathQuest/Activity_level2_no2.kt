...
class Activitylevel2no2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level2_no2)
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level2_no2)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            ...
            val intent = Intent(this, Activitysoal3level2::class.java)
            startActivity(intent)
            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
