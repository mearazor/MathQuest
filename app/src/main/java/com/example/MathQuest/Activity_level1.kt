...
class Activitylevel1 : AppCompatActivity() {
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level1_no1)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            ...
            val intent = Intent(this, Activitysoal2level1::class.java)
            startActivity(intent)
            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
            finish() // Optional: Menutup Activity saat pindah ke activity_soal2_level1
        }
        btnNo.setOnClickListener {
