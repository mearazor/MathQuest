...
class Activitylevel3no4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level3_no4)
    ...
    private fun showPopup() {
        ...
        popup.setContentView(R.layout.popup_level3_no4)
    ...
    private fun showBenarPopup() {
        ...
        btnYes.setOnClickListener {
            ...
            val intent = Intent(this, Activitywinner::class.java)
            startActivity(intent)
            // Memberikan efek transisi fade
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
